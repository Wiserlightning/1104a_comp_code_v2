...
void set_drive_velocity(int drive_velocity_left, int drive_velocity_right) {
    drive_top_left.move_velocity(drive_velocity_left);
    drive_top_right.move_velocity(drive_velocity_left);
    drive_bottom_left.move_velocity(drive_velocity_right);
    drive_bottom_right.move_velocity(drive_velocity_right);
}
